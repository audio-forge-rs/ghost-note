...
define(['./workbox-959db468'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "index.html",
    "revision": "0.719fgej02t8"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\.(?:json|txt)$/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\.(?:png|jpg|jpeg|gif|svg|webp|ico)$/i, new workbox.CacheFirst({
